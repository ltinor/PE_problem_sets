...
原题及更多讨论见 [https://projecteuler.net/problem=935](https://projecteuler.net/problem=935)。
...
- 字符 `PE`：输出原题（F(10^8)）的官方答案；
- 或两个整数 p, q（1 ≤ p < q ≤ 2000, 互素）：输出 b = p/q 的首回归步数（0 = 不回归）。
...
- 1 ≤ p < q ≤ 2000（互素）
- 检查值: b = 1/2 → 4、b = 1/3 → 8、b = 5/13 → 24
- PE 答案: F(10^8) = 759908921637225
