#!/usr/bin/env python3
"""PE 836-840: Verification script."""
import subprocess, os, sys

PROBLEMS = {
    836: ("apr2024",                  "A Message in a Mess / 混乱中的信息"),
    837: ("572410.960905",            "Minimal Circles / 最小圆"),
    838: ("3610283147900864",         "Not Relatively Prime / 不互质"),
    839: ("229260851949018",          "Beans in Bowls / 碗中豆"),
    840: ("0.277319553",              "Sum of Products / 乘积和"),
}
