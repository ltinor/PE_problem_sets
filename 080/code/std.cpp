...
// Big integer utilities (string-based, no leading zeros)
...
// Add a small int (single digit) to a big int string
...
// Concatenate digit to big int (multiply by 10 and add digit)
