...
原题及更多讨论见 [https://projecteuler.net/problem=951](https://projecteuler.net/problem=951)。
...
- 字符 `PE`：输出原题（n = 26）的官方答案；
- 或一个整数 n（1 ≤ n ≤ 26）：输出 F(n)。
...
- 1 ≤ n ≤ 26
- 检查值: F(2) = 4、F(8) = 11892（原题给定）
- PE 答案: F(26) = 495568995495726
