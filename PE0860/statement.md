# Problem 860 — Gold and Silver Coin Game / 金银硬币游戏
...
Define F(n) to be the number of fair arrangements of n stacks, all of size 2. Different orderings of the stacks are to be counted separately, so F(2) = 4. You are also given F(10) = 63594.

Find F(9898). Give your answer modulo 989898989.

**Answer: 71743330777707**
