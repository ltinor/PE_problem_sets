...
原题及更多讨论见 [https://projecteuler.net/problem=902](https://projecteuler.net/problem=902)。
...
- 字符 `PE`：输出原题（$m = 100$）的官方答案；
- 或一个整数 $m$：输出 $P(m) mod (10^9 + 7)$。
...
$1 \le m \le 100$（$n = m(m+1)/2 \le 5050$）
