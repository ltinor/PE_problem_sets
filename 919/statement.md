...
原题及更多讨论见 [https://projecteuler.net/problem=919](https://projecteuler.net/problem=919)。
...
- 字符 `PE`：输出原题（P = 10^7）的官方答案；
- 或一个整数 P（1 ≤ P ≤ 10^7）：输出 S(P)。
